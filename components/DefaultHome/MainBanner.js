                                ...
                                <div className="row">
                                    <div className="col-lg-6">
                                        <div className="main-banner-content">
                                            {/* <span>ARTTECH MEDYA</span> */}
                                            <h1>SANATLA TEKNOLOJİNİN BULUŞMA NOKTASI!</h1>
                                            <p>Arttech'in güvenli dijital dünyası ile tanışmak için
doğru yerdesiniz.</p>

                                            <Link href="/contact">
                                                <a className="btn btn-primary">Başlayalım</a>
                                            </Link>
